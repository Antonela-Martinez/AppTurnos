...
//2:El tipo de dato que representa el ID de esta entidad>
//Extiende de JpaRepository, para que cuando spring encuentre esta interfaz(ProfesionalRepository)sepa que tiene que ser creada como un repositorio 
...
@Repository
public interface ProfesionalRepository extends UserRepository<Profesional>{
